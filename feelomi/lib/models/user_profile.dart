...
// These functions should be generated by build_runner
// Remove these placeholder implementations after running build_runner
UserSettings _$UserSettingsFromJson(Map<String, dynamic> json) {
  return UserSettings(
    notificationsEnabled: json['notificationsEnabled'] as bool? ?? true,
    reminderTimes: (json['reminderTimes'] as List<dynamic>?)
        ?.map((e) => e as String)
        .toList() ?? const ['09:00', '21:00'],
    theme: UserSettings._themeFromJson(json['theme'] as String? ?? 'system'),
    language: UserSettings._languageFromJson(json['language'] as String? ?? 'fr'),
...
Map<String, dynamic> _$UserSettingsToJson(UserSettings instance) => <String, dynamic>{
  ...
  'theme': UserSettings._themeToJson(instance.theme),
  'language': UserSettings._languageToJson(instance.language),
