...
class Constants {
  ...
  static class NavArgs {
    ...
    static const String professionalId = "professional_id";
  ...
  static class AnalyticsEvents {
    ...
    static const String completeHabit = "complete_habit";
    static const String deleteHabit = "delete_habit";
